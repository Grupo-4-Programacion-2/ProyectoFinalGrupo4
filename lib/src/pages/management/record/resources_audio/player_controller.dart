...
import 'package:pm2_pf_grupo_4/src/pages/management/record/resources_audio/audio_controller.dart';

class PlayerUpdateController extends GetxController {
  final AudioUpdateController audioController = Get.put(AudioUpdateController());
